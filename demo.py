...
with col3:
  ...
  st.image("https://media3.giphy.com/media/KfxPezYC20OnSPQK5J/giphy.gif",caption="bird singing",use_column_width=True)
  st.write("Birds are so beautiful")
with col4:
  st.subheader("Blue bird moving")
  st.image("https://peter-ertl.com/birds/images/blaumeise-5.gif",caption="bird",use_column_width=True)
  st.write("Blue Birds are so beautiful")
with col5:
  st.subheader("Nandu Chintu")
  st.video("https://youtu.be/PGjMtclhx_U",caption="Nach",width=300,use_column_width=True)
